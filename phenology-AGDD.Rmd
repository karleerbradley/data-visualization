...
#### Adding more packages to the library.
...
Plotting AGDDs for 2017 using the first method of calculating AGDDs from the mean temperatures.
...
#### Selecting the DBL species in the leaves phenophase
...
#### Counting the number of each species in the leaves phenophase by day
